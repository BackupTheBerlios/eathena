...
// map server からの通信
// ・１"ケットのみ解析すること
// ・"ケット長データはinter.cにセットしておくこと
// ・"ケット長チェックや、RFIFOSKIPは呼び出し元で行われるので行ってはならない
