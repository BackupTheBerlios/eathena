// $Id: mob.c,v 1.1 2004/01/08 23:08:47 mjflick Exp $
#include <stdio.h>
#include <stdlib.h>
#include <stdarg.h>
#include <string.h>
...
int mobskill_castend_pos( int tid, unsigned int tick, int id,int data )
{
	...
	if( md->skilltimer != tid )	// タイマIDの確認
		return 0;
	md->skilltimer=-1;
	if(skill_get_range(md->skillid, md->skilllv) + battle_config.mob_skill_add_range < distance(md->bl.x,md->bl.y,md->skillx,md->skilly))
		return 0;
	md->skilldelay[md->skillidx]=tick;
